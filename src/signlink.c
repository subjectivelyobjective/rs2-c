...
// // TODO: Consider writing to the sign struct directly, error handling
// char *signlink_findcachedir(signlink *sign)
// {
// 	if (sign == NULL) {
// 		fprintf(stderr, "[ERROR] Failed to find cache dir: signlink is NULL.\n");
// 		return NULL;
// 	}
...
// 		if (strncmp(POSSIBLE_LOCS[i], "~/", PATH_MAX) == 0) {
// 			int err = put_home_dir(candidate_parent);
// 			if (err) {
// 				fprintf(stderr, "[ERROR] Failed to find cache dir: err code %d.\n", err);
// 				return NULL;
// 			}
// 			loc_len = strnlen(candidate_parent, PATH_MAX);
// 		} else if (strncmp(POSSIBLE_LOCS[i], "", PATH_MAX) == 0) {
...
//  		} else {
// 			loc_len = strnlen(POSSIBLE_LOCS[i], PATH_MAX);
// 			memcpy(candidate_parent, POSSIBLE_LOCS[i], loc_len + 1);
// 		}
...
// 		memcpy(candidate_parent + loc_len, file_store_dir,
// 			FILE_STORE_LEN + 1);
// 		loc_len += FILE_STORE_LEN;
...
// 			candidate_parent[loc_len++] = '/';
// 			candidate_parent[loc_len] = '\0';
// 			return strndup(candidate_parent, loc_len);
// 		}
// 	}
